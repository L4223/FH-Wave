...
class _RequestScreenState extends State<RequestScreen> {
  ...
  Future<void> acceptInvite(String groupName) async {
    var groupId = await _groupController.getGroupIdFromGroupName(groupName);
    _groupController.addMemberToGroup(groupId, currentUser!.uid);
  }
}
